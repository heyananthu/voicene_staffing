                    ...
                    <div className="bg-white w-[95%] max-w-3xl p-6 sm:p-8 lg:p-10 rounded-2xl shadow-xl overflow-y-auto max-h-[90vh] relative transform transition-all duration-300 scale-100 hover:scale-[1.01]">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex gap-3 justify-center">
                                <button type="submit" className="px-6 py-2 rounded-md  bg-gradient-to-r from-purple-600 to-indigo-600 text-white font-semibold hover:from-purple-700 hover:to-indigo-700 transition-all duration-300 disabled:from-purple-800 disabled:to-indigo-800  disabled:bg-blue-400 flex items-center justify-center gap-2" disabled={isSubmitting}>
                                    {isSubmitting && (
